...
[data, labels] = later_getData('JT', '/MATLAB Drive', 0.2);
RTs = data.rt;
clear data
...
%reciprocalRTs = 1 ./ RTs;
%deltaS = 1 / std(reciprocalRTs);
%muR = mean(reciprocalRTs) * deltaS;
initialValues = [muRs, deltaSs];
...
global reciprocalRTs
reciprocalRTs = 1 ./ RTs;  % RTs must be defined beforehand
